...
class THOC(nn.Module):
    ...
    https://proceedings.neurips.cc/paper/2020/file/97e401a02082021fd24957f852e0e475-Paper.pdf
    ...
    def __init__(self, C, W, n_hidden, tau=1):
        ...
        self.C, self.W = C, W
        self.L = math.floor(math.log(W, 2)) + 2 # Number of DRNN layers
        self.tau = tau
    ...
    def forward(self, X):
        ...
        for i, cluster in enumerate(self.clusters):
            ...
            # Update
            c_vectors = self.cnets[i](f_t_bar)
            f_t_bar = torch.einsum("Bnp,Bph->Bnh", P_ij.transpose(-1, -2), c_vectors)
...
class DRNN(nn.Module):
    ...
    https://arxiv.org/pdf/1710.02224
